...
export default function MainTable({  setFilteredTransactions }) {
  ...
  async function fetchData(){
    const transactionsData =await axios.get('https://api-nine-psi-40.vercel.app/transactions'); 
    const customersData =await axios.get('https://api-nine-psi-40.vercel.app/customers');
